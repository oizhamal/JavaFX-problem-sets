...
public class Controller {
    ...
    public void initialize() {
        contacts.add(new Contact("Aelina", "Daniiar", "aelina.daniiarkyzy_2025@ucentralasia.org", "+97523464973", "5522529"));
        contacts.add(new Contact("Ermek", "Ilikeshova", "ermeki@gmail.com", "+192342343", "4354020"));
        contacts.add(new Contact("Aizada", "Berdibekova", "aberdibekova@gmail.com", "+1948482347489", "0425340"));
        contacts.add(new Contact("Aisha", "Toichieva", "aisha.toichieva@gmail.com", "+194542345433", "463250"));
        contacts.add(new Contact("Aizhamal", "Zhetigenova", "azhetigenova@gmail.com", "+194542345433", "463250"));
